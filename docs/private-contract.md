...
| Column-default value changes that silently re-shape inserted rows | MEDIUM | Schema lint catches default *literal* changes; downstream data-flow impact requires manual review | OSS PR review + spatula-saas integration |

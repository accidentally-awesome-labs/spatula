...
Plans:
- [ ] 18-01-PLAN.md — Prompt-injection defense (7 mitigations) + output scanner + 10 adversarial fixtures + adversarial-llm.yml CI lane
- [ ] 18-02-PLAN.md — Shared redactor module + pino/Sentry/OTel sink wiring + per-sink redaction test suite
...
| 18. Security Hardening & Legal            | v1.1      | 0/7            | Planned     | -          |

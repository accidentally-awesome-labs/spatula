...
- [ ] **Phase 15: Carve-out & Migration Squash** — Extract billing/Stripe/metering to private `spatula-saas`; squash OSS migrations to `000_v1_baseline.sql`; ship reverse-contract test.
...
**Plans:** 6 plans
Plans:
- [ ] 15-01-PLAN.md — BLOCK-01 verify + pre-cut snapshot + coupling re-grep + feature branch
- [ ] 15-02-PLAN.md — Filter-repo move of Section A files → spatula-saas (history preserved) + OSS deletion
- [ ] 15-03-PLAN.md — Strip in-place coupling across 5 packages + new GET /api/v1/auth/me + CLI rewire
...
- 8 CARVE-* → Phase 15
- 14 API-* + 8 SDK-* → Phase 16
- 8 AUTH-* → Phase 17
- 12 SEC-* + 8 LEGAL-* → Phase 18
- 11 DEPLOY-* → Phase 19
- 10 DOCS-* → Phase 20
- 12 CONTRIB-* → Phase 21
- 20 LAUNCH-* → Phase 22
...
| 15. Carve-out & Migration Squash | v1.1 | 0/6 | Not started | - |
...
*Milestone v1.1 — Public Launch (Wave 6 / Phase 14)*

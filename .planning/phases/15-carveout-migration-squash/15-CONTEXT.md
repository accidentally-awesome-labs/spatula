...
- Reverse-contract test ergonomics: the mocked private consumer file should look like a *realistic* `spatula-saas` import block — not a synthetic enumeration — so silent removals fail with messages a saas-side developer would immediately recognize.

 ...
 *
 * These exact model IDs are frozen by SEC-02. Any change to these strings
 * constitutes a pin rotation and requires re-running the full adversarial suite
 * against the new model(s) before merging.
 *

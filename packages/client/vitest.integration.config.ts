...
/**
 * Integration-mode vitest config for @accidentally-awesome-labs/spatula-client.
 *
...
export default defineConfig({
  test: {
    ...
    // only via `pnpm --filter @accidentally-awesome-labs/spatula-client test:integration`.
  },
});
